...
our $I18N = {
    ...
    'Error: Search string' => {
        ...
        'lastUpdated' => 1270834474,
        'message'     => 'Crikey: search string'
    },
    'Warning: Ending search point' => {
        'context'     => 'i18n fragment used in default HTTP Proxy template',
        'lastUpdated' => 1270834474,
        'message'     => 'Crikey search point'
    },
    'assetName' => {
        'lastUpdated' => 1270834474,
        'message'     => 'HTTP Proxy'
    ...
    'content.leading' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Any text before the <b>Search Four</b> string.'
    },
    'content.trailing' => {
        'lastUpdated' => 1270834474,
...
'
    ...
    'no recursion' => {
        ...
        'lastUpdated' => 1270834474,
        'message'     => '<p>Crikey: HttpProxy can\'t recursively proxy its own content.</p>'
    },
