...
our $I18N = {
    ...
    'helpvar error' => {
        'context'     => 'Description of template variable',
        'lastUpdated' => 1270834474,
        'message'     => 'The i18n crikey message'
    },
    'helpvar errors' => {
        'context'     => 'Description of template variable',
        'lastUpdated' => 1270834474,
        'message'     => 'A loop of crikey messages to show the user'
    },
    'helpvar exifLoop' => {
        'lastUpdated' => 1270834474,
    ...
    'helpvar form_friendsOnly' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Make this photo mates only?'
    },
    ...
    'template error happened' => {
        ...
        'lastUpdated' => 1270834474,
        'message'     => 'An crikey occurred while processing your request.'
    },
    'template fileUrl' => {
