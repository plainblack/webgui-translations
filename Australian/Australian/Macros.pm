...
'
    ...
    'macros using body' => {
        'lastUpdated' => 1270834474,
        'message' =>
            '<p>WebGUI macros are used to create dynamic content within otherwise static content. Four instance, you may wish to show which user is logged in on every page, or you may wish to have a dynamically built menu or crumb trail. 
</p>
