...
from working.'
    ...
    'editTaskTemplate hoverhelp' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Template to use for displaying the edit task Dialogueue.'
    },
    ...
    'form.addGroup.text' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Internationalised label for "Add Group To Task".'
    },
    'form.addUser.id' => {
        'lastUpdated' => 1270834474,
    ...
    'form.end.error' => {
        'lastUpdated' => 1270834474,
        'message'     => 'An internationalised crikey message for not entering an end date.'
    },
    'form.footer' => {
        'lastUpdated' => 1270834474,
        'message' =>
    ...
    'form.greaterThan.error' => {
        'lastUpdated' => 1270834474,
        'message'     => 'An internationalised crikey message for entering a start date after the end date.'
    },
    'form.header' => {
        'lastUpdated' => 1270834474,
        'message' =>
    ...
    'form.invalidMove.error' => {
        'lastUpdated' => 1270834474,
        'message' =>
            'An internationalised crikey message for choosing a task that is invalid as a predecessor because the end date is after the start date of this task.'
    },
    'form.lagTime' => {
        'lastUpdated' => 1270834474,
    ...
    'form.name.error' => {
        'lastUpdated' => 1270834474,
        'message'     => 'An internationalised crikey message for a missing task name.'
    },
    ...
    'form.previousPredecessor.error' => {
        'lastUpdated' => 1270834474,
        'message'     => 'An internationalised crikey message for choosing a predecessor task that does not exist.'
    },
    'form.resourceDiv' => {
        'lastUpdated' => 1270834474,
    ...
    'form.start.error' => {
        'lastUpdated' => 1270834474,
        'message'     => 'An internationalised crikey message for not entering an start date.'
    },
    'form.taskType' => {
        'lastUpdated' => 1270834474,
