...
our $I18N = {
    'Error: Cannot instantiate template' => {
        ...
        'message'     => 'Crikey: Cannot instantiate template %s for class %s'
    },
    'account className' => {
    ...
    'account identifier' => {
        ...
        'lastUpdated' => 1270834474,
        'message' =>
            'The identifier for this plugin, from the config file.  Default identifiers are profile, inbox, mates, contributions, shop and user.'
    },
