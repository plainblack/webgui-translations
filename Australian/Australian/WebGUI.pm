...
<p>Optionally, if you are running a sendmail server on the same machine as WebGUI, you can also specify a path to your sendmail executable. On most Linux systems this can be found at "/usr/lib/sendmail".</p>'
    ...
    '141 description' => {
        'lastUpdated' => 1270834474,
        'message' =>
            'If a page that a user requests is not found in the system, the user can either be redirected to the home page or to an crikey page where they can attempt to find what they were looking for. You decide which is better for your users. '
    },
    '142' => {
        'lastUpdated' => 1270834474,
...
%s_%d<br />'
    ...
    '848' => {
        'lastUpdated' => 1270834474,
        'message'     => 'There is a syntax crikey in this template. Please correct.'
    },
    '85' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Description'
...
<i>IP Mask Example:</i> 10.0.0.32/27, 192.168.0.1/30
    ...
    '863 description' => {
        'lastUpdated' => 1270834474,
        'message' =>
            '<p>The difference in the number of days from the expiration to the grouping being deleted from the system. You may set this to any valid integer. Four instance, set this to "0" if you wish the grouping to be deleted on the same day that the grouping expires. Set it to "-7" if you want the grouping to be deleted 7 days <b>before</b> the grouping expires. Set it to "7" if you wish the grouping to be deleted 7 days after the expiration.
</p>'
    },
    '864' => {
        'lastUpdated' => 1270834474,
...
<p><b>Type</b><br />The type of content.  Four instance, a Page, Article, EventsCalendar, etc.</p>
...
You must be using mod_perl and configure <b>PerlSetEnv SYBASE /opt/sybase/11.0.2</b> in httpd.conf.
    ...
    'Check out what is going on.' => {
        ...
        'lastUpdated' => 1270834474,
        'message'     => 'Cheque out what is going on.'
    },
    'Clear' => {
...
a user.'
    ...
    'Thanks for for your interest in ^c;. We will review your message shortly.' => {
        ...
        'lastUpdated' => 1270834474,
        'message'     => 'Cheers for for your interest in ^c;. We will review your message shortly.'
    },
...
'
    ...
    'debug ip description' => {
        'lastUpdated' => 1270834474,
        'message' =>
            'This will limit debugging and/or performance output to a specific IP address or IP range. Enter the subnet that you want to be able to view debug output in CIDR format.  Four example: 10.0.0.0/24.  Multiple CIDR addresses may be entered, separated by commas.'
    },
    'default rich editor' => {
        'lastUpdated' => 1270834474,
    ...
    'external help' => {
        'lastUpdated' => 1270834474,
        'message' =>
            '<p>Four more help, visit the <a href="http://wiki.webgui.org/">WebGUI Community Wiki</a>.</p>'
    },
    'fieldType' => {
...
<p><b>NOTE:</b> Do NOT include the dot "." in this. So the field should look like "html" not ".html".
    ...
    'user profile field friend availability' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Are you available to be added as a Mate?'
    },
