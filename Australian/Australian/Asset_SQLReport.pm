...
our $I18N = {
    '10' => {
        ...
        'message'     => '<b>Debug:</b> Crikey: The SQL specified is of an improper format.'
    },
    '11' => {
        'lastUpdated' => 1270834474,
        'message'     => '<b>Debug:</b> Crikey: There was a problem with the query.'
    },
    '12' => {
        'lastUpdated' => 1270834474,
        'message'     => '<b>Debug:</b> Crikey: Could not connect to the database.'
    },
    '14' => {
        'lastUpdated' => 1270834474,
    ...
    '16 description' => {
        'lastUpdated' => 1270834474,
        'message'     => '<p>If you want to display debugging and crikey messages on the page, cheque this box.
</p>'
    },
    '17' => {
        'lastUpdated' => 1270834474,
...
'
    ...
    'Prequery error' => {
        'lastUpdated' => 1270834474,
        'message'     => '<b>Debug:</b> An crikey occured in prequery'
    },
    ...
    'Prequery statements description' => {
        'lastUpdated' => 1270834474,
        'message' =>
            '<p>Prequery statements are sql statements executed before the real query. You can use prequery statements for instance to set variables that you want to use in the real query. Four example:</p>
