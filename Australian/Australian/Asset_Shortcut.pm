...
The statement may be entered by hand, or it can be built graphically using the Criteria builder.  Four each criteria that you want to enter, select the value for the metadata field and the operator.  Then, use the conjunction field to choose how it works with the other criteria, and hit the Add button for the field you want to add.'
    ...
    'Place something in this box if you dont want to use the automatically generated field' => {
        'lastUpdated' => 1270834474,
        'message' =>
            'Place something in this box if you don\'t want to use the automatically generated field.  You may also insert user preference values into this field by using the following syntax: if you wanted it to display "My Favourite colour is blue.", and you have a user preference field called myFavColor, in this box you would put: My Favourite Colour is ##userPref:myFavColor##.'
    },
    'Possible Values' => {
        'lastUpdated' => 1270834474,
...
Most Recent will select the most recent asset that matches the shortcut criteria.'
    ...
    'pref fields to import description' => {
        'lastUpdated' => 1270834474,
        'message' =>
            'These are the user profile fields you want exposed to your override fields (in the form ##userPref:nameOfProfileField##).  Cheque these if you want to expose profile fields from other areas of the site or the general user profile fields.'
    },
    'pref fields to show' => {
        'lastUpdated' => 1270834474,
