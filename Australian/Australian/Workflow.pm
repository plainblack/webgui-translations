...
our $I18N = {
    ...
    'bad workflow activity code' => {
        ...
        'lastUpdated' => 1270834474,
        'message'     => 'Syntax crikey found in %s, unable to edit this activity.'
    },
    ...
    'edit priority setting error' => {
        'context'     => '',
        'lastUpdated' => 1270834474,
        'message'     => 'There was an crikey setting the new priority.'
    },
    ...
    'edit priority unknown error' => {
        'context'     => '',
        'lastUpdated' => 1270834474,
        'message'     => 'There was an unknown crikey updating the workflow priority. Please try again later.'
    },
