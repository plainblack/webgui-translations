...
our $I18N = {
    ...
    'cancel error' => {
        ...
        'lastUpdated' => 1270834474,
        'message' =>
            'An crikey has occurred while cancelling the recurring transaction. Please contact the admin. Crikey: '
    },
    'cancelUrl' => {
        'lastUpdated' => 1270834474,
    ...
    'errorMessage' => {
        'lastUpdated' => 1270834474,
        'message'     => 'A message with an crikey concerning the cancellation of recurring payment.'
    },
    'gateway' => {
        'lastUpdated' => 1270834474,
