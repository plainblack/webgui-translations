...
our $I18N = {
    ...
    'insurance rates help' => {
        ...
        'lastUpdated' => 1270834474,
        'message' =>
            'Enter in one field per line with the format, value:cost.<br />value is the value of the contents.<br />cost is the cost of insurance at that value.<br />value and cost should look like numbers with a decimal point, like 0.50 or 1.00.<br />Four values of contents inbetween points, use the next highest value.  If the value of the contents exceeds the highest listed value, it will use the cost of insurance at the highest listed value.'
    },
    'parcel post' => {
        'context'     => 'Label for a type of shipping from the USPS.',
        'lastUpdated' => 1270834474,
