...
our $I18N = {
    ...
    '7 description' => {
        'lastUpdated' => 1270834474,
        'message' =>
            'The label used to describe the LDAP Authentication Attribute to the user. Four instance, some companies use an LDAP server for their proxy server users to authenticate against. In the documentation or training already provided to their users, the LDAP Authentication Attribute is known as their <i>Web Username</i>. So you could enter that label here for consistency.  Used to be called LDAP Identity Label.'
    },
    '8' => {
        'lastUpdated' => 1270834474,
...
<p>cn=Joe Shmoe,ou=people,dc=example,dc=com</p>'
    ...
    'create.form.ldapConnection.label' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Internationalised label for the drop-down list <b>create.form.ldapConnection</b>'
    },
    'create.form.ldapId' => {
        'lastUpdated' => 1270834474,
