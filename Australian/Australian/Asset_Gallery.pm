...
our $I18N = {
    ...
    'error add uncommitted' => {
        ...
        'lastUpdated' => 1270834474,
        'message'     => '<h1>Crikey!</h1><p>You must commit this Gallery before adding albums</p>'
    },
    ...
    'help listFilesForUser title' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Gallery List Files Four User Variables'
    },
    ...
    'help listFilesForUserRss title' => {
        'lastUpdated' => 1270834474,
        'message'     => 'Gallery List Files Four User RSS Variables'
    },
    'help search body' => {
        'lastUpdated' => 1270834474,
