...
<p><i>Note:</i> You should always specify a title, even if the Asset template will not use it. In various places on the site, like the Page Tree, Clipboard and Trash, the <b>Title</b> is used to distinguish this Asset from others.</p>'
    ...
    'Error getting asset with assetId %s' => {
        ...
        'lastUpdated' => 1270834474,
        'message'     => 'Crikey getting asset with assetId %s'
    },
    'Error: Cannot instantiate template' => {
        'context'     => 'Error message in Asset.pm',
        'lastUpdated' => 1270834474,
        'message'     => 'Crikey: Cannot instantiate template'
    },
    'Export Page' => {
...
be appended to it.</p>'
    ...
    'duplicateField' => {
        'lastUpdated' => 1270834474,
        'message'     => '<p><b>Crikey: Fieldname "%field%" is already in use.</b></p>'
    },
    'edit' => {
        'context'     => 'Used in asset context menus.',
        'lastUpdated' => 1270834474,
    ...
    'edit branch url help' => {
        'lastUpdated' => 1270834474,
        'message' =>
            '<p>You can change the URL via two parts, the base URL (the left field) and the file url (the right field).  Four the base URL, there are three options:</p>
<div>
<dl>
<dt>Parent URL</dt>
...
'
    ...
    'errorEmptyField' => {
        'lastUpdated' => 1270834474,
        'message'     => '<p><b>Crikey: Field name may not be empty.</b></p>'
    },
    'export' => {
        'context'     => 'Label for the menu to show actions to perform on an asset',
        'lastUpdated' => 1270834474,
...
throughout the site.  Cheque yes if you want this Asset to be available as a package.</p>'
    },
    'make prototype' => {
        'lastUpdated' => 1270834474,
    ...
    'package extract error' => {
        'lastUpdated' => 1270834474,
        'message' =>
            'Unable to extract package!  The package may be corrupt, or there may be a server crikey preventing packages from being imported.'
    },
    'packages' => {
